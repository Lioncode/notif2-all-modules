...
class PeriodicTask(models.Model):
    ...
    number_of_repetitions = fields.Integer(string="Number of repetitions", required=True, track_visibility='always')
            ...
            for periodic_task in periodic_tasks:
                ...
                if project.active:
                    if int(periodic_task.periodicity) == int(number_of_days):
                        ...
                        periodic_task.generated_tasks = [(4, r.id)]
                        periodic_task.number_of_repetitions = periodic_task.number_of_repetitions - 1
                        if periodic_task.number_of_repetitions <= 0:
                            periodic_task.active = False
